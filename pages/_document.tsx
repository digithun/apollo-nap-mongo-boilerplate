    ...
    return (
      <html>
        <Head>
          ...
          <meta httpEquiv='Content-Security-Policy' content='frame-ancestors https://beta.jamplay.world' />
          <meta httpEquiv='Content-Security-Policy' content='frame-ancestors https://staging.jamplay.world' />
